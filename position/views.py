...
def position_marketplace_calculations(request, buyer_seller, rpg_manual_round, group_bonus_check=0):
    ...
    for group in allGroupCharacterSheet:
        ...
        bonus_flex_points, flex_points, all_gifts, all_gifts_sent, overproduction_flex_fee = calculate_flex_points(final_deals, rpg_mod_units, rpg_closest_round, currentClassName, group.groupDigit, flex_points, group.groupRole)
...
#----------------------------GET MARKETPLACE ARRAY OF DATA-------    
    ...
    context = {
        ...
        'rpg_fraction_close_to_max': (rpg_fraction_close_to_max) * 100,
        'rpg_fraction_close_to_mod': (rpg_fraction_close_to_mod) * 100,
...
#-------------------QUERY GIFTS SENT ONLY TOTAL SUM----------------
def query_gifts_sent(rpg_closest_round, currentClassName, currentGroupNumber):
    # Query the gifting model
    all_gifts_sent = gifting.objects.filter(
        groupRPG=rpg_closest_round,
        groupClass=currentClassName,
        groupDigit=currentGroupNumber
...
def calculate_flex_points(final_deals, rpg_mod_units, rpg_closest_round, currentClassName, currentGroupNumber, flex_points, groupRole):
    ...
    # Query the gifting model
    all_gifts = query_gifts(rpg_closest_round, currentClassName, currentGroupNumber)
    all_gifts_sent = query_gifts_sent(rpg_closest_round, currentClassName, currentGroupNumber)
    ...
    return bonus_flex_points, flex_points, all_gifts, all_gifts_sent, overproduction_flex_fee
