...
def position_marketplace_calculations(request, buyer_seller): # 1 for buyer/seller page -1 for marketplace
    ...
    for group in allGroupCharacterSheet:
        ...
        bonus_flex_points, flex_points, all_gifts = calculate_flex_points(final_deals, rpg_mod_units, rpg_closest_round, currentClassName, group.groupDigit, flex_points)
        ...
        if filtered_deals: #only if some valid deals exist (as generated by function: fetch_and_filter_deals )
            scoreA = resistance - average_weighted
        ...
        group_data = {
            ...
            #'canceled_deals_count': canceled_deals_count,
            #'all_groups_results': all_deals,
